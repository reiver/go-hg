...
and then put _TLS proxy_ server in front of it (listening at ":1965") that modifies any "gemini://..." URI in the **Gemini Protocol** request into a "mercury://..." URI before sending it to the ☿ **Mercury Protocol** server.
