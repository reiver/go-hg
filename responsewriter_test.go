...
func TestResponseWriter_WriteHeader_success(t *testing.T) {
	...
	tests := []struct{
		...
		{
			StatusCode:  0,
			Meta:         "With tomorrow's sun, another day's begun",
			Expected:  "00 With tomorrow's sun, another day's begun\r\n",
		},
		{
			StatusCode:  2,
			Meta:         "👾 💙",
		...
		},
		{
			StatusCode:  5,
			Meta:         "۰۱۲۳۴۵۶۷۸۹",
			Expected:  "05 ۰۱۲۳۴۵۶۷۸۹\r\n",
		},
		{
			StatusCode: 99,
			Meta:         "With tomorrow's sun, another day's begun",
			Expected:  "99 With tomorrow's sun, another day's begun\r\n",
		},
	}
